// Live AI news & community feeds for /news (ported from thanabartbb/main web/src/feeds.js).
...
export async function fetchSource(id, { fetchImpl = fetch, githubToken } = {}) {
  ...
  const headers = { 'User-Agent': 'lsuperagent-docs-news/1.0 (+https://agents-sdk.space)' };
  if (src.kind === 'github') {
